...
//go:generate minimock -i github.com/zcolleen/minimock/v3/tests.genericMultipleTypes -o generic_multiple_args_with_different_types.go -n GenericMultipleTypesMock -p tests
