...
//go:generate minimock -i github.com/zcolleen/minimock/v3/tests.genericInlineUnionWithManyTypes -o generic_inline_with_many_options.go -n GenericInlineUnionWithManyTypesMock -p tests
