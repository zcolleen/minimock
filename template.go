...
const (
	...
	HeaderTemplate = `
		...
		// Code generated by http://github.com/zcolleen/minimock ({{$.Options.HeaderVars.Version}}). DO NOT EDIT.
		...
		import (
			{{range $import := $.Options.Imports}}{{- if not (in $import "\"time\"" "\"sync/atomic\"" "\"github.com/zcolleen/minimock/v3\"")}}
				{{$import}}{{end}}{{end}}
